...
<form method="GET" action="wine_result.php">
<?php
  require "db.php";
...
<br><label>Minimum Number of Wines Order:</label><input name="minOrder" type="text">
<br><label>Cost Range:</label><input name="costMin" type="text">&nbsp to &nbsp<input name="costMax" type="text">
<br><br><input name="submitBtn" type = "submit" value="search">
</form>
